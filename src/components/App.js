...
const App = ({locationHash, globalStore}) => (
    React.createElement('div', {className:"container center body-content-wrapper"},
        React.createElement(SideMenu, {locationHash: locationHash, globalStore: globalStore}),
        React.createElement("hr"),
        function () {
            switch (locationHash) {
                case "#inbox":
                    return React.createElement(MainWindow, {globalStore: globalStore})
                // case "#download":
